...
namespace IFramework.Queue
{
    ...
    public sealed class FastPriorityQueue<T> : IFixedSizePriorityQueue<T, float> where T : FastPriorityQueueNode
    {
        ...
        public bool Contains(T node)
        {
            ...
            {
                throw new InvalidOperationException("node.position has been corrupted. Did you change it manually? Or add this node to another queue?");
            }
#endif
        ...
        {
#if NET_VERSION_4_5 // ArraySegment在4.5之前没有实现IEnumerable接口
