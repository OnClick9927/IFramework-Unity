...
namespace IFramework.GUIGames
{
	...
	public class Game_BWC:EditorWindow
	{
       ...
       static Map map;
        ...
        static TextLabel wCount, bCount;
        private void OnEnable()
        {
            this.maxSize = new Vector2(600, 600);

            XmlDocument doc = new XmlDocument();
            string path = FrameworkConfig.FrameworkPath.CombinePath("GUIGames/BWC/Editor/Game_BWC.xml");
            doc.Load(path);
            ...
            wCount= guiCanvas.Find<TextLabel>("top/count/w/count");
            bCount = guiCanvas.Find<TextLabel>("top/count/b/count");
