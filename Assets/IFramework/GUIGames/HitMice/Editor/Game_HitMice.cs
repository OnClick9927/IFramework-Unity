...
{
    [EditorWindowCache("Game_HitMice")]
	public class Game_HitMice:EditorWindow
	{
        ...
        private void OnEnable()
        {
            ...
            string path = FrameworkConfig.FrameworkPath.CombinePath("GUIGames/HitMice/Resources/Game_HitMice.xml");
            doc.Load(path);
            ...
            score = 0;
            second = 0;
            guiCanvas.Find<TextLabel>("BG/top/score").text = score.ToString();
