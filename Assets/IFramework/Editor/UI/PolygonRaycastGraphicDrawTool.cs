...
{
    public class PolygonRaycastGraphicDrawTool<T> where T : UnityEngine.MonoBehaviour, IPolygonRaycastGraphic
    {
        class SelectionInfo
        {
        ...
        private void DrawWithDisc()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                Handles.color = i == selectionInfo.lineIndex ? Color.green : Color.yellow;
                    Handles.DrawLine(start, end,8);
                //if (i == selectionInfo.lineIndex)
                //{
                //}
                //else
                //{
                //    Handles.DrawDottedLine(start, end, 8);
                //}
            }
