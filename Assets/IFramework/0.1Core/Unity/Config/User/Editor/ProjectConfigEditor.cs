...
{
    public partial class ProjectConfigEditor
    {
        ...
        public static string ProjectConfigInfoPath = FrameworkConfig.UnityCorePath.CombinePath("Config/Resources/" + ProjectConfig.infoName + ".asset").ToRegularPath();
        private static void LoadProjectInfo()
        {
            string[] guids = AssetDatabase.FindAssets("t:ProjectConfigInfo", new string[] { @"Assets" });
