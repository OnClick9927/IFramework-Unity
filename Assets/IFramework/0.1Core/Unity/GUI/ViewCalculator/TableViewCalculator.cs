...
namespace IFramework
{
    ...
    public class TableViewCalculator
    {
        ...
        public void Calc(Rect position, Vector2 content, Vector2 scroll, float rowHeight, int rowCount, ListViewCalculator.ColumnSetting[] setting)
        {
            ...
            ListView.Calc(new Rect(position.x,
                                ...
                                position.width,
                                position.height - rowHeight), content, scroll,
                                    rowHeight,
                                    rowCount, setting);
