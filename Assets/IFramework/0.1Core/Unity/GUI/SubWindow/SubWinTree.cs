...
namespace IFramework
{
    public class SubWinTree
    {
        ...
        private class TreeRoot : TreeTrunk
        {
            ...
            internal override int depth { get { return 0; } }
            ...
            internal override void CalcPosition(Rect position)
            {
                if (isEmpty) return;
        ...
        internal class TreeTrunk : TreeNode
        {
            ...
            internal override XmlElement Serialize(XmlDocument doc)
            {
            ...
            internal override void DeSerialize(XmlElement root)
            {
        ...
        public class TreeLeaf : TreeNode
        {
            ...
            public Action<Rect> paintDelegate { get; set; }
            ...
            public TreeLeaf(GUIContent title) : base() { m_minSize = new Vector2(Styles.minize, Styles.minize); this.titleContent = title; }
        ...
        public abstract class TreeNode
        {
            ...
            internal virtual int depth { get { return parent.depth + 1; } }
            ...
            internal bool IsOver(Vector2 v) { return m_position.Contains(v); }
            internal virtual void CalcPosition(Rect position) { this.m_position = position; }

            internal abstract void OnGUI();

            internal virtual XmlElement Serialize(XmlDocument doc)
            {
            ...
            internal virtual void DeSerialize(XmlElement root)
            {
        ...
        public Action repaintEve { get; set; }
        public Action<Rect, SplitType> drawCursorEve { get; set; }
        public Action<TreeLeaf> onCreatLeaf { get; set; }
        public Action<TreeLeaf> onDockLeaf { get; set; }
        public Action<TreeLeaf> onCloseLeaf { get; set; }
        public Action<TreeLeaf> onClearLeaf { get; set; }
        public Action onResizeWindow { get; set; }
        public Action onEndResizeWindow { get; set; }
        public Action onDragWindow { get; set; }
        public Action onEndDragWindow { get; set; }
        ...
        private static XmlElement SerializeField<T>(XmlElement root, string name, T value)
        {
            try
            {
                ...
                {
                    Log.W(/*GetType() + */"  " + name + "  value is mull,will not Serializate");
                }
                return root;
            }
            catch (Exception)
