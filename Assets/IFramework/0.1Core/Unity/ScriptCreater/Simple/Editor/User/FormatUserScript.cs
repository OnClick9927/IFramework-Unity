...
namespace IFramework
{
    class FormatUserScript
    {
        ...
        private class FormatUserCSScript
        {
            ...
            private static string originScriptPathWithNameSpace = FrameworkConfig.UnityCorePath.CombinePath(@"ScriptCreater/Simple/Editor/User/CSharpScript.txt");
        ...
        {
            private static string newScriptName = "newScript.cs";
            private static string originScriptPathWithNameSpace = FrameworkConfig.UnityCorePath.CombinePath(@"ScriptCreater/Simple/Editor/User/MonoScript.txt");
