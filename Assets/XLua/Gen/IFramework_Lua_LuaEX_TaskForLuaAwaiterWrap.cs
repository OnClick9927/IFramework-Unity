...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkLuaLuaEXTaskForLuaAwaiterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Lua.LuaEX.TaskForLuaAwaiter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<IFramework.Lua.TaskForLua>(L, 2))
				{
					IFramework.Lua.TaskForLua _task = (IFramework.Lua.TaskForLua)translator.GetObject(L, 2, typeof(IFramework.Lua.TaskForLua));
					
					var gen_ret = new IFramework.Lua.LuaEX.TaskForLuaAwaiter(_task);
				...
				{
				    translator.Push(L, default(IFramework.Lua.LuaEX.TaskForLuaAwaiter));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Lua.LuaEX.TaskForLuaAwaiter constructor!");
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Lua.LuaEX.TaskForLuaAwaiter gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
