...
{
    public class IFrameworkLuaILuaTaskBridge : LuaBase, IFramework.Lua.ILuaTask
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new IFrameworkLuaILuaTaskBridge(reference, luaenv);
		}
		
		public IFrameworkLuaILuaTaskBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		object IFramework.Lua.ILuaTask.GetResult()
		{
		...
		string IFramework.Lua.ILuaTask.GetException()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void IFramework.Lua.ILuaTask.OnCompleted(System.Action continuation)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
        ...
        bool IFramework.Lua.ILuaTask.IsCompleted 
        {
