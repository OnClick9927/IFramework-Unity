...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit7(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(RecordGame), RecordGameWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(redPointGame), redPointGameWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(PanelNames_UIGame), PanelNames_UIGameWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(UIGame), UIGameWrap.__Register);
        ...
        static void wrapInit8(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(IFramework.Lua.LuaEnvConfig), IFrameworkLuaLuaEnvConfigWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(IFramework.Lua.LuaGame), IFrameworkLuaLuaGameWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(UIGame.Asset), UIGameAssetWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Tutorial.CSCallLua.DClass), TutorialCSCallLuaDClassWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(IFramework.Lua.LuaEX.LuaTaskAwaiter), IFrameworkLuaLuaEXLuaTaskAwaiterWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(IFramework.Lua.LuaEX.TaskForLuaAwaiter), IFrameworkLuaLuaEXTaskForLuaAwaiterWrap.__Register);
        ...
        static void Init(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.AddInterfaceBridgeCreator(typeof(IFramework.Lua.ILuaTask), IFrameworkLuaILuaTaskBridge.__Create);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate IFramework.IAwaiter __GEN_DELEGATE2( IFramework.Lua.ILuaTask target);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(IFramework.Lua.ILuaTask), new List<MethodInfo>(){
				
				  new __GEN_DELEGATE2(IFramework.Lua.LuaEX.GetAwaiter)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
