...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkLuaTaskForLuaWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Lua.TaskForLua);
			Utils.BeginObjectRegister(type, L, translator, 0, 2, 2, 1);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetComplete", _m_SetComplete);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new IFramework.Lua.TaskForLua();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to IFramework.Lua.TaskForLua constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetComplete(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Lua.TaskForLua gen_to_be_invoked = (IFramework.Lua.TaskForLua)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    
                    gen_to_be_invoked.SetComplete(  );
