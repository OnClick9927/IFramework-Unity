...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIGraphicRegistryWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "DisableGraphicForCanvas", _m_DisableGraphicForCanvas_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "DisableRaycastGraphicForCanvas", _m_DisableRaycastGraphicForCanvas_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DisableGraphicForCanvas_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.UI.GraphicRegistry.DisableGraphicForCanvas( _c, _graphic );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DisableRaycastGraphicForCanvas_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.UI.GraphicRegistry.DisableRaycastGraphicForCanvas( _c, _graphic );
